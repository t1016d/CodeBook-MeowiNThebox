...
\subsection{xorFFT}
\lstinputlisting{../math/xorFFT.cpp}
\subsection{orFFT}
\lstinputlisting{../math/orFFT.cpp}
\subsection{andFFT}
\lstinputlisting{../math/andFFT.cpp}
...
\lstinputlisting{../flow/Min-Cost-Max-flow.cpp}
...
\subsection{Suffix Array(SAIS, twt)}
\lstinputlisting{../string/sais_twt514.cpp}
...
\lstinputlisting{../string/palindrome_automaton.cpp}

\subsection{Suffix Automaton(bcw)}
\lstinputlisting{../string/Suffix_automaton_bcw.cpp}
...
\lstinputlisting{../graph/general_graph_matching_other.cpp}
...
\lstinputlisting{../graph/DMT.cpp}

\subsection{Min Cut}
\lstinputlisting{../graph/min_cut.cpp}

\subsection{DMST with sol(bcw)}
\lstinputlisting{../graph/dmst_sol_bcw.cpp}
...
\lstinputlisting{../datastructure/Seg2D.cpp}
...
\subsection{HalfPlaneNSquare}
\lstinputlisting{../geometry/HalfPlaneNSquare.cpp}

\subsection{LineIntersection}
\lstinputlisting{../geometry/LineIntersection.cpp}

\subsection{OldCircleInter}
\lstinputlisting{../geometry/OldCircleInter.cpp}

\subsection{PolyCircleIntersect}
\lstinputlisting{../geometry/PolyCircleIntersect.cpp}
...
\subsection{Smallest circle problem}
...
\lstinputlisting{../others/slope.cpp}
